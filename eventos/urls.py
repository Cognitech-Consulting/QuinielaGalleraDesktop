...
urlpatterns = [
    ...
    path('admin/resultados/', views.lista_eventos_resultados, name='lista_eventos_resultados'),
    path('admin/resultados/<int:event_id>/', views.ver_resultados_evento, name='ver_resultados_evento'),
]